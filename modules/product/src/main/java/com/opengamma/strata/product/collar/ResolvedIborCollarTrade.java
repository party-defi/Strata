 ...
 */
@BeanDefinition
public final class ResolvedIborCollarTrade
   ...
   */
  @PropertyDefinition(validate = "notNull", overrideGet = true)
  private final ResolvedIborCollar product;
  /**
  ...
  private ResolvedIborCollarTrade(
      TradeInfo info,
      ResolvedIborCollar product,
      Payment premium) {
   ...
   */
  @Override
  public ResolvedIborCollar getProduct() {
    return product;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ResolvedIborCollarTrade other = (ResolvedIborCollarTrade) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<TradeInfo> info = DirectMetaProperty.ofImmutable(
        this, "info", ResolvedIborCollarTrade.class, TradeInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<ResolvedIborCollar> product = DirectMetaProperty.ofImmutable(
        this, "product", ResolvedIborCollarTrade.class, ResolvedIborCollar.class);
    /**
     * The meta-property for the {@code premium} property.
     */
    private final MetaProperty<Payment> premium = DirectMetaProperty.ofImmutable(
        this, "premium", ResolvedIborCollarTrade.class, Payment.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public Class<? extends ResolvedIborCollarTrade> beanType() {
      return ResolvedIborCollarTrade.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<ResolvedIborCollar> product() {
      return product;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3237038:  // info
          return ((ResolvedIborCollarTrade) bean).getInfo();
        case -309474065:  // product
          return ((ResolvedIborCollarTrade) bean).getProduct();
        case -318452137:  // premium
          return ((ResolvedIborCollarTrade) bean).premium;
      }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<ResolvedIborCollarTrade> {

    private TradeInfo info;
    private ResolvedIborCollar product;
     ...
     */
    private Builder(ResolvedIborCollarTrade beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case 3237038:  // info
          ...
          break;
        case -309474065:  // product
          this.product = (ResolvedIborCollar) newValue;
          break;
        case -318452137:  // premium
    ...
    @Override
    public ResolvedIborCollarTrade build() {
      return new ResolvedIborCollarTrade(
          info,
          product,
          premium);
    }
     ...
     * @return this, for chaining, not null
     */
    public Builder product(ResolvedIborCollar product) {
      JodaBeanUtils.notNull(product, "product");
      this.product = product;
      return this;
    }
