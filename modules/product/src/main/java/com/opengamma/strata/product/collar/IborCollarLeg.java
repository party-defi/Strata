...
public final class IborCollarLeg
    implements Resolvable<ResolvedIborCollarLeg>, ImmutableBean, Serializable {
  ...
  public ResolvedIborCollarLeg resolve(ReferenceData refData) {
    ...
    ImmutableList.Builder<IborCollarletPeriod> periodsBuild = ImmutableList.builder();
    for (int i = 0; i < adjustedSchedule.size(); i++) {
      ...
      periodsBuild.add(IborCollarletPeriod.builder()
    ...
    return ResolvedIborCollarLeg.builder()
        .collarletPeriods(periodsBuild.build())
        .payReceive(payReceive)
        .build();
  }
   ...
   */
  public static IborCollarLeg.Meta meta() {
    return IborCollarLeg.Meta.INSTANCE;
  }

  static {
    MetaBean.register(IborCollarLeg.Meta.INSTANCE);
  }
   ...
   */
  public static IborCollarLeg.Builder builder() {
    return new IborCollarLeg.Builder();
  }

  @Override
  public IborCollarLeg.Meta metaBean() {
    return IborCollarLeg.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      IborCollarLeg other = (IborCollarLeg) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PayReceive> payReceive = DirectMetaProperty.ofImmutable(
        this, "payReceive", IborCollarLeg.class, PayReceive.class);
    /**
    ...
    private final MetaProperty<PeriodicSchedule> paymentSchedule = DirectMetaProperty.ofImmutable(
        this, "paymentSchedule", IborCollarLeg.class, PeriodicSchedule.class);
    /**
    ...
    private final MetaProperty<DaysAdjustment> paymentDateOffset = DirectMetaProperty.ofImmutable(
        this, "paymentDateOffset", IborCollarLeg.class, DaysAdjustment.class);
    /**
     * The meta-property for the {@code currency} property.
     */
    private final MetaProperty<Currency> currency = DirectMetaProperty.ofImmutable(
        this, "currency", IborCollarLeg.class, Currency.class);
    /**
     * The meta-property for the {@code notional} property.
     */
    private final MetaProperty<ValueSchedule> notional = DirectMetaProperty.ofImmutable(
        this, "notional", IborCollarLeg.class, ValueSchedule.class);
    /**
    ...
    @Override
    public IborCollarLeg.Builder builder() {
      return new IborCollarLeg.Builder();
    }

    @Override
    public Class<? extends IborCollarLeg> beanType() {
      return IborCollarLeg.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -885469925:  // payReceive
          return ((IborCollarLeg) bean).getPayReceive();
        case -1499086147:  // paymentSchedule
          return ((IborCollarLeg) bean).getPaymentSchedule();
        case -716438393:  // paymentDateOffset
          return ((IborCollarLeg) bean).getPaymentDateOffset();
        case 575402001:  // currency
          return ((IborCollarLeg) bean).getCurrency();
        case 1585636160:  // notional
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<IborCollarLeg> {
     ...
     */
    private Builder(IborCollarLeg beanToCopy) {
    ...
    @Override
    public IborCollarLeg build() {
      return new IborCollarLeg(
          payReceive,
          paymentSchedule,
          paymentDateOffset,
          currency,
