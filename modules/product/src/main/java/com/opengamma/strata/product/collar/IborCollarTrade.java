 ...
 * <p>
 * An Over-The-Counter (OTC) trade in a {@link IborCollar}.
 * <p>
 ...
 */
@BeanDefinition
public final class IborCollarTrade
    implements ProductTrade, ResolvableTrade<ResolvedIborCollarTrade>, ImmutableBean, Serializable {
   ...
   */
  @PropertyDefinition(validate = "notNull", overrideGet = true)
  private final IborCollar product;
  /**
  ...
  //-------------------------------------------------------------------------
  @Override
  public IborCollarTrade withInfo(PortfolioItemInfo info) {
    return new IborCollarTrade(TradeInfo.from(info), product, premium);
  }
  ...
  public PortfolioItemSummary summarize() {
    ...
    IborCollarLeg collarLeg = product.getCollarLeg();
    buf.append(SummarizerUtils.datePeriod(collarLeg.getStartDate().getUnadjusted(), collarLeg.getEndDate().getUnadjusted()));
    buf.append(' ');
    buf.append(SummarizerUtils.amount(collarLeg.getCurrency(), collarLeg.getNotional().getInitialValue()));
    buf.append(' ');
    if (collarLeg.getPayReceive().isReceive()) {
      buf.append("Rec ");
      summarizeMainLeg(collarLeg, buf);
    ...
    buf.append(" : ");
    buf.append(SummarizerUtils.dateRange(collarLeg.getStartDate().getUnadjusted(), collarLeg.getEndDate().getUnadjusted()));
    return SummarizerUtils.summary(this, ProductType.IBOR_CAP_FLOOR, buf.toString(), collarLeg.getCurrency());
  }
  ...
  @Override
  public ResolvedIborCollarTrade resolve(ReferenceData refData) {
    return ResolvedIborCollarTrade.builder()
        .info(info)
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      IborCollarTrade other = (IborCollarTrade) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<TradeInfo> info = DirectMetaProperty.ofImmutable(
        this, "info", IborCollarTrade.class, TradeInfo.class);
    /**
     * The meta-property for the {@code product} property.
     */
    private final MetaProperty<IborCollar> product = DirectMetaProperty.ofImmutable(
        this, "product", IborCollarTrade.class, IborCollar.class);
    /**
    ...
    private final MetaProperty<AdjustablePayment> premium = DirectMetaProperty.ofImmutable(
        this, "premium", IborCollarTrade.class, AdjustablePayment.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public Class<? extends IborCollarTrade> beanType() {
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<IborCollar> product() {
      return product;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3237038:  // info
          return ((IborCollarTrade) bean).getInfo();
        case -309474065:  // product
          return ((IborCollarTrade) bean).getProduct();
        case -318452137:  // premium
          return ((IborCollarTrade) bean).premium;
      }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<IborCollarTrade> {

    private TradeInfo info;
    private IborCollar product;
     ...
     */
    private Builder(IborCollarTrade beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case 3237038:  // info
          ...
          break;
        case -309474065:  // product
          this.product = (IborCollar) newValue;
          break;
        case -318452137:  // premium
    ...
    @Override
    public IborCollarTrade build() {
      return new IborCollarTrade(
          info,
          product,
          premium);
    }
     ...
     * @return this, for chaining, not null
     */
    public Builder product(IborCollar product) {
      JodaBeanUtils.notNull(product, "product");
      this.product = product;
      return this;
    }
