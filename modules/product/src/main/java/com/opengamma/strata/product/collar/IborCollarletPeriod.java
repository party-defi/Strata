...
public final class IborCollarletPeriod
  ...
  private static void preBuild(Builder builder) {
    ...
    ArgChecker.isTrue(builder.caplet != null && builder.floorlet != null, "Both caplet and floorlet must be set");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Double> caplet = DirectMetaProperty.ofImmutable(
        this, "caplet", IborCollarletPeriod.class, Double.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1367656183:  // caplet
          return ((IborCollarletPeriod) bean).caplet;
        case 2022994575:  // floorlet
