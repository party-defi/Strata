...
/**
 * A period over which an Ibor collarlet payoff is paid.
 * <p>
 ...
 * <p>
 * The payoffs are, for an Ibor index on the fixingDate of 'I' and an year fraction 'a'<br>
 * Ibor collarlet: a * (I-K)^+ ; K=collarlet<br>  //FIXME - need to replace with collarlet definiton
 * <p>
 * The payment is a collarlet.
 * {@code collarlet} is not null.
 * <p>
 * If start date and end date of the period, and payment date are not specified, a standard collarlet is created
 * based on the data and convention in {@code rateComputation},  i.e., the Ibor is fixed in advance and paid in arrears.
 * <p>
 * An {@code IborCollarletPeriod} is bound to data that changes over time, such as holiday calendars.
 * If the data changes, such as the addition of a new holiday, the resolved form will not be updated.
 * Care must be taken when placing the resolved form in a cache or persistence layer.
 */
@BeanDefinition
public final class IborCollarletPeriod
  ...
  /**
   * The optional collarlet strike.
   * <p>
   * This defines the strike value of a collarlet.
   * <p>
   * If the period is not a collarlet, this field will be absent.
   */
  @PropertyDefinition(get = "optional")
  private final Double collarlet;
  /**
  ...
  private static void preBuild(Builder builder) {
    ...
    ArgChecker.isTrue(builder.collarlet != null, "collarlet must be set");
  ...
  public double getStrike() {
    return firstNonNull(collarlet, floorlet);
  }

  /**
   * Gets put or call.
   * <p>
   * CALL is returned for a collarlet, whereas PUT is returned for a floorlet.
   *
   * @return put or call
   */
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code IborCollarletPeriod}.
   * @return the meta-bean, not null
   */
  public static IborCollarletPeriod.Meta meta() {
    return IborCollarletPeriod.Meta.INSTANCE;
  }

  static {
    MetaBean.register(IborCollarletPeriod.Meta.INSTANCE);
  }
   ...
   */
  public static IborCollarletPeriod.Builder builder() {
    return new IborCollarletPeriod.Builder();
  }

  private IborCollarletPeriod(
      Currency currency,
      double notional,
      LocalDate startDate,
      LocalDate endDate,
    ...
    this.collarlet = collarlet;
    this.floorlet = floorlet;
    this.iborRate = iborRate;
  }

  @Override
  public IborCollarletPeriod.Meta metaBean() {
    return IborCollarletPeriod.Meta.INSTANCE;
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the optional collarlet strike.
   * <p>
   * This defines the strike value of a collarlet.
   * <p>
   * If the period is not a collarlet, this field will be absent.
  ...
  public OptionalDouble getCaplet() {
    return collarlet != null ? OptionalDouble.of(collarlet) : OptionalDouble.empty();
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      IborCollarletPeriod other = (IborCollarletPeriod) obj;
      return JodaBeanUtils.equal(currency, other.currency) &&
          ...
          JodaBeanUtils.equal(collarlet, other.collarlet) &&
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(collarlet);
  ...
  public String toString() {
    ...
    buf.append("IborCollarletPeriod{");
    ...
    buf.append("collarlet").append('=').append(JodaBeanUtils.toString(collarlet)).append(',').append(' ');
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Currency> currency = DirectMetaProperty.ofImmutable(
        this, "currency", IborCollarletPeriod.class, Currency.class);
    /**
     * The meta-property for the {@code notional} property.
     */
    private final MetaProperty<Double> notional = DirectMetaProperty.ofImmutable(
        this, "notional", IborCollarletPeriod.class, Double.TYPE);
    /**
     * The meta-property for the {@code startDate} property.
     */
    private final MetaProperty<LocalDate> startDate = DirectMetaProperty.ofImmutable(
        this, "startDate", IborCollarletPeriod.class, LocalDate.class);
    /**
     * The meta-property for the {@code endDate} property.
     */
    private final MetaProperty<LocalDate> endDate = DirectMetaProperty.ofImmutable(
        this, "endDate", IborCollarletPeriod.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<LocalDate> unadjustedStartDate = DirectMetaProperty.ofImmutable(
        this, "unadjustedStartDate", IborCollarletPeriod.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<LocalDate> unadjustedEndDate = DirectMetaProperty.ofImmutable(
        this, "unadjustedEndDate", IborCollarletPeriod.class, LocalDate.class);
    /**
     * The meta-property for the {@code yearFraction} property.
     */
    private final MetaProperty<Double> yearFraction = DirectMetaProperty.ofImmutable(
        this, "yearFraction", IborCollarletPeriod.class, Double.TYPE);
    /**
     * The meta-property for the {@code paymentDate} property.
     */
    private final MetaProperty<LocalDate> paymentDate = DirectMetaProperty.ofImmutable(
        this, "paymentDate", IborCollarletPeriod.class, LocalDate.class);
    /**
     * The meta-property for the {@code collarlet} property.
     */
    private final MetaProperty<Double> collarlet = DirectMetaProperty.ofImmutable(
        this, "collarlet", IborCollarletPeriod.class, Double.class);
    /**
    ...
    private final MetaProperty<Double> floorlet = DirectMetaProperty.ofImmutable(
        this, "floorlet", IborCollarletPeriod.class, Double.class);
    /**
    ...
    private final MetaProperty<IborRateComputation> iborRate = DirectMetaProperty.ofImmutable(
        this, "iborRate", IborCollarletPeriod.class, IborRateComputation.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public IborCollarletPeriod.Builder builder() {
      return new IborCollarletPeriod.Builder();
    }

    @Override
    public Class<? extends IborCollarletPeriod> beanType() {
      return IborCollarletPeriod.class;
    }
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<Double> collarlet() {
      return collarlet;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 575402001:  // currency
          return ((IborCollarletPeriod) bean).getCurrency();
        case 1585636160:  // notional
          return ((IborCollarletPeriod) bean).getNotional();
        case -2129778896:  // startDate
          return ((IborCollarletPeriod) bean).getStartDate();
        case -1607727319:  // endDate
          return ((IborCollarletPeriod) bean).getEndDate();
        case 1457691881:  // unadjustedStartDate
          return ((IborCollarletPeriod) bean).getUnadjustedStartDate();
        case 31758114:  // unadjustedEndDate
          return ((IborCollarletPeriod) bean).getUnadjustedEndDate();
        case -1731780257:  // yearFraction
          return ((IborCollarletPeriod) bean).getYearFraction();
        case -1540873516:  // paymentDate
          return ((IborCollarletPeriod) bean).getPaymentDate();
        case -1367656183:  // collarlet
          return ((IborCollarletPeriod) bean).collarlet;
        case 2022994575:  // floorlet
          return ((IborCollarletPeriod) bean).floorlet;
        case -1621804100:  // iborRate
          return ((IborCollarletPeriod) bean).getIborRate();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code IborCollarletPeriod}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<IborCollarletPeriod> {
     ...
     */
    private Builder(IborCollarletPeriod beanToCopy) {
      ...
      this.collarlet = beanToCopy.collarlet;
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case -1540873516:  // paymentDate
          ...
          break;
        case -1367656183:  // collarlet
          this.collarlet = (Double) newValue;
          break;
        case 2022994575:  // floorlet
    ...
    @Override
    public IborCollarletPeriod build() {
      preBuild(this);
      return new IborCollarletPeriod(
          currency,
          notional,
          startDate,
          endDate,
    ...
    /**
     * Sets the optional collarlet strike.
     * <p>
     * This defines the strike value of a collarlet.
     * <p>
     * If the period is not a collarlet, this field will be absent.
     * @param collarlet  the new value
     * @return this, for chaining, not null
     */
    public Builder collarlet(Double collarlet) {
      this.collarlet = collarlet;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(384);
      buf.append("IborCollarletPeriod.Builder{");
      buf.append("currency").append('=').append(JodaBeanUtils.toString(currency)).append(',').append(' ');
      buf.append("notional").append('=').append(JodaBeanUtils.toString(notional)).append(',').append(' ');
      buf.append("startDate").append('=').append(JodaBeanUtils.toString(startDate)).append(',').append(' ');
      buf.append("endDate").append('=').append(JodaBeanUtils.toString(endDate)).append(',').append(' ');
