...
import com.opengamma.strata.pricer.collar.BlackIborCollarletExpiryStrikeVolatilities;
import com.opengamma.strata.pricer.collar.NormalIborCollarletExpiryStrikeVolatilities;
import com.opengamma.strata.pricer.collar.ShiftedBlackIborCollarletExpiryStrikeVolatilities;
 ...
 */
public class IborCollarletDataSet {
   ...
   */
  public static BlackIborCollarletExpiryStrikeVolatilities createBlackVolatilities(
      ZonedDateTime valuationDate,
      IborIndex index) {
    return BlackIborCollarletExpiryStrikeVolatilities.of(index, valuationDate, BLACK_SURFACE_EXP_STR);
  }
   ...
   * @return  the volatilities provider
   */
  public static BlackIborCollarletExpiryStrikeVolatilities createBlackVolatilitiesFlat(
      ZonedDateTime valuationDate,
      IborIndex index) {
    return BlackIborCollarletExpiryStrikeVolatilities.of(index, valuationDate, SHIFTED_BLACK_SURFACE_EXP_FLAT);
  }
   ...
   * @return  the volatilities provider
   */
  public static ShiftedBlackIborCollarletExpiryStrikeVolatilities createShiftedBlackVolatilities(
      ZonedDateTime valuationDate,
      IborIndex index) {
    return ShiftedBlackIborCollarletExpiryStrikeVolatilities.of(
   ...
   * @return  the volatilities provider
   */
  public static NormalIborCollarletExpiryStrikeVolatilities createNormalVolatilities(
      ZonedDateTime valuationDate,
      IborIndex index) {
    return NormalIborCollarletExpiryStrikeVolatilities.of(index, valuationDate, NORMAL_SURFACE_EXP_STR);
  }
