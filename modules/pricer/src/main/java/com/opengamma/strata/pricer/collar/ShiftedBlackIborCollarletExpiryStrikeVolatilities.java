...
public final class ShiftedBlackIborCollarletExpiryStrikeVolatilities
   ...
   */
  public static ShiftedBlackIborCollarletExpiryStrikeVolatilities of(
      IborIndex index,
      ZonedDateTime valuationDateTime,
      Surface surface,
      Curve shiftCurve) {

    return new ShiftedBlackIborCollarletExpiryStrikeVolatilities(index, valuationDateTime, surface, shiftCurve);
  }

  @ImmutableConstructor
  private ShiftedBlackIborCollarletExpiryStrikeVolatilities(
      IborIndex index,
      ZonedDateTime valuationDateTime,
      Surface surface,
      Curve shiftCurve) {
  ...
  @Override
  public ShiftedBlackIborCollarletExpiryStrikeVolatilities withParameter(int parameterIndex, double newValue) {
    return new ShiftedBlackIborCollarletExpiryStrikeVolatilities(
        index, valuationDateTime, surface.withParameter(parameterIndex, newValue), shiftCurve);
  }

  @Override
  public ShiftedBlackIborCollarletExpiryStrikeVolatilities withPerturbation(ParameterPerturbation perturbation) {
    return new ShiftedBlackIborCollarletExpiryStrikeVolatilities(
   ...
   */
  public static ShiftedBlackIborCollarletExpiryStrikeVolatilities.Meta meta() {
    return ShiftedBlackIborCollarletExpiryStrikeVolatilities.Meta.INSTANCE;
  }

  static {
    MetaBean.register(ShiftedBlackIborCollarletExpiryStrikeVolatilities.Meta.INSTANCE);
  }
  ...
  @Override
  public ShiftedBlackIborCollarletExpiryStrikeVolatilities.Meta metaBean() {
    return ShiftedBlackIborCollarletExpiryStrikeVolatilities.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ShiftedBlackIborCollarletExpiryStrikeVolatilities other = (ShiftedBlackIborCollarletExpiryStrikeVolatilities) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<IborIndex> index = DirectMetaProperty.ofImmutable(
        this, "index", ShiftedBlackIborCollarletExpiryStrikeVolatilities.class, IborIndex.class);
    /**
     * The meta-property for the {@code valuationDateTime} property.
     */
    private final MetaProperty<ZonedDateTime> valuationDateTime = DirectMetaProperty.ofImmutable(
        this, "valuationDateTime", ShiftedBlackIborCollarletExpiryStrikeVolatilities.class, ZonedDateTime.class);
    /**
     * The meta-property for the {@code surface} property.
     */
    private final MetaProperty<Surface> surface = DirectMetaProperty.ofImmutable(
        this, "surface", ShiftedBlackIborCollarletExpiryStrikeVolatilities.class, Surface.class);
    /**
    ...
    private final MetaProperty<Curve> shiftCurve = DirectMetaProperty.ofImmutable(
        this, "shiftCurve", ShiftedBlackIborCollarletExpiryStrikeVolatilities.class, Curve.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends ShiftedBlackIborCollarletExpiryStrikeVolatilities> builder() {
      return new ShiftedBlackIborCollarletExpiryStrikeVolatilities.Builder();
    }

    @Override
    public Class<? extends ShiftedBlackIborCollarletExpiryStrikeVolatilities> beanType() {
      return ShiftedBlackIborCollarletExpiryStrikeVolatilities.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 100346066:  // index
          return ((ShiftedBlackIborCollarletExpiryStrikeVolatilities) bean).getIndex();
        case -949589828:  // valuationDateTime
          return ((ShiftedBlackIborCollarletExpiryStrikeVolatilities) bean).getValuationDateTime();
        case -1853231955:  // surface
          return ((ShiftedBlackIborCollarletExpiryStrikeVolatilities) bean).getSurface();
        case 1908090253:  // shiftCurve
          return ((ShiftedBlackIborCollarletExpiryStrikeVolatilities) bean).getShiftCurve();
      }
   ...
   */
  private static final class Builder extends DirectPrivateBeanBuilder<ShiftedBlackIborCollarletExpiryStrikeVolatilities> {
    ...
    @Override
    public ShiftedBlackIborCollarletExpiryStrikeVolatilities build() {
      return new ShiftedBlackIborCollarletExpiryStrikeVolatilities(
          index,
          valuationDateTime,
          surface,
