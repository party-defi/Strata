...
import com.opengamma.strata.pricer.collar.IborCollarletSensitivity;
import com.opengamma.strata.pricer.collar.IborCollarletVolatilitiesName;
import com.opengamma.strata.pricer.collar.NormalIborCollarletVolatilities;
...
public final class NormalIborCollarletExpiryStrikeVolatilities
    implements NormalIborCollarletVolatilities, ImmutableBean, Serializable {
   ...
   */
  public static NormalIborCollarletExpiryStrikeVolatilities of(
      IborIndex index,
      ZonedDateTime valuationDateTime,
      Surface surface) {

    return new NormalIborCollarletExpiryStrikeVolatilities(index, valuationDateTime, surface);
  }

  @ImmutableConstructor
  private NormalIborCollarletExpiryStrikeVolatilities(
      IborIndex index,
      ZonedDateTime valuationDateTime,
      Surface surface) {
  ...
  public IborCollarletVolatilitiesName getName() {
    return IborCollarletVolatilitiesName.of(surface.getName().getName());
  }
  ...
  @Override
  public NormalIborCollarletExpiryStrikeVolatilities withParameter(int parameterIndex, double newValue) {
    return new NormalIborCollarletExpiryStrikeVolatilities(
        index, valuationDateTime, surface.withParameter(parameterIndex, newValue));
  }

  @Override
  public NormalIborCollarletExpiryStrikeVolatilities withPerturbation(ParameterPerturbation perturbation) {
    return new NormalIborCollarletExpiryStrikeVolatilities(
  ...
  public CurrencyParameterSensitivities parameterSensitivity(PointSensitivities pointSensitivities) {
    ...
    for (PointSensitivity point : pointSensitivities.getSensitivities()) {
      if (point instanceof IborCollarletSensitivity) {
        IborCollarletSensitivity pt = (IborCollarletSensitivity) point;
  ...
  private CurrencyParameterSensitivity parameterSensitivity(IborCollarletSensitivity point) {
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code NormalIborCollarletExpiryStrikeVolatilities}.
   * @return the meta-bean, not null
   */
  public static NormalIborCollarletExpiryStrikeVolatilities.Meta meta() {
    return NormalIborCollarletExpiryStrikeVolatilities.Meta.INSTANCE;
  }

  static {
    MetaBean.register(NormalIborCollarletExpiryStrikeVolatilities.Meta.INSTANCE);
  }
  ...
  @Override
  public NormalIborCollarletExpiryStrikeVolatilities.Meta metaBean() {
    return NormalIborCollarletExpiryStrikeVolatilities.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      NormalIborCollarletExpiryStrikeVolatilities other = (NormalIborCollarletExpiryStrikeVolatilities) obj;
  ...
  public String toString() {
    ...
    buf.append("NormalIborCollarletExpiryStrikeVolatilities{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<IborIndex> index = DirectMetaProperty.ofImmutable(
        this, "index", NormalIborCollarletExpiryStrikeVolatilities.class, IborIndex.class);
    /**
     * The meta-property for the {@code valuationDateTime} property.
     */
    private final MetaProperty<ZonedDateTime> valuationDateTime = DirectMetaProperty.ofImmutable(
        this, "valuationDateTime", NormalIborCollarletExpiryStrikeVolatilities.class, ZonedDateTime.class);
    /**
     * The meta-property for the {@code surface} property.
     */
    private final MetaProperty<Surface> surface = DirectMetaProperty.ofImmutable(
        this, "surface", NormalIborCollarletExpiryStrikeVolatilities.class, Surface.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends NormalIborCollarletExpiryStrikeVolatilities> builder() {
      return new NormalIborCollarletExpiryStrikeVolatilities.Builder();
    }

    @Override
    public Class<? extends NormalIborCollarletExpiryStrikeVolatilities> beanType() {
      return NormalIborCollarletExpiryStrikeVolatilities.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 100346066:  // index
          return ((NormalIborCollarletExpiryStrikeVolatilities) bean).getIndex();
        case -949589828:  // valuationDateTime
          return ((NormalIborCollarletExpiryStrikeVolatilities) bean).getValuationDateTime();
        case -1853231955:  // surface
          return ((NormalIborCollarletExpiryStrikeVolatilities) bean).getSurface();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code NormalIborCollarletExpiryStrikeVolatilities}.
   */
  private static final class Builder extends DirectPrivateBeanBuilder<NormalIborCollarletExpiryStrikeVolatilities> {
    ...
    @Override
    public NormalIborCollarletExpiryStrikeVolatilities build() {
      return new NormalIborCollarletExpiryStrikeVolatilities(
          index,
          valuationDateTime,
          surface);
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("NormalIborCollarletExpiryStrikeVolatilities.Builder{");
      buf.append("index").append('=').append(JodaBeanUtils.toString(index)).append(',').append(' ');
      buf.append("valuationDateTime").append('=').append(JodaBeanUtils.toString(valuationDateTime)).append(',').append(' ');
      buf.append("surface").append('=').append(JodaBeanUtils.toString(surface));
      buf.append('}');
