 ...
 * <p>
 * The pricing methodologies are defined in individual implementations of the volatilities, {@link IborCollarletVolatilities}.
 * <p>
 ...
 * <p>
 * The consistency between {@code RatesProvider} and {@code IborCollarletVolatilities} is not checked in this
 * class, but validated only once in {@link VolatilityIborCollarLegPricer}.
 */
public class VolatilityIborCollarletPeriodPricer {

  /**
   * Default implementation.
   */
  public static final VolatilityIborCollarletPeriodPricer DEFAULT = new VolatilityIborCollarletPeriodPricer();
   ...
   */
  public double forwardRate(IborCollarletPeriod period, RatesProvider ratesProvider) {
  ...
  public PointSensitivityBuilder presentValueSensitivityModelParamsVolatility(
    ...
    return IborCollarletSensitivity.of(
   ...
   * {@code IborCollarletVolatilities} is used for pricing.
   * 
   * @param volatilities  the volatilities
   */
