...
public final class BlackIborCollarletExpiryStrikeVolatilities
   ...
   */
  public static BlackIborCollarletExpiryStrikeVolatilities of(
      IborIndex index,
      ZonedDateTime valuationDateTime,
      Surface surface) {

    return new BlackIborCollarletExpiryStrikeVolatilities(index, valuationDateTime, surface);
  }

  @ImmutableConstructor
  private BlackIborCollarletExpiryStrikeVolatilities(
      IborIndex index,
      ZonedDateTime valuationDateTime,
      Surface surface) {
  ...
  @Override
  public BlackIborCollarletExpiryStrikeVolatilities withParameter(int parameterIndex, double newValue) {
    return new BlackIborCollarletExpiryStrikeVolatilities(
        index, valuationDateTime, surface.withParameter(parameterIndex, newValue));
  }

  @Override
  public BlackIborCollarletExpiryStrikeVolatilities withPerturbation(ParameterPerturbation perturbation) {
    return new BlackIborCollarletExpiryStrikeVolatilities(
   ...
   */
  public static BlackIborCollarletExpiryStrikeVolatilities.Meta meta() {
    return BlackIborCollarletExpiryStrikeVolatilities.Meta.INSTANCE;
  }

  static {
    MetaBean.register(BlackIborCollarletExpiryStrikeVolatilities.Meta.INSTANCE);
  }
  ...
  @Override
  public BlackIborCollarletExpiryStrikeVolatilities.Meta metaBean() {
    return BlackIborCollarletExpiryStrikeVolatilities.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      BlackIborCollarletExpiryStrikeVolatilities other = (BlackIborCollarletExpiryStrikeVolatilities) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<IborIndex> index = DirectMetaProperty.ofImmutable(
        this, "index", BlackIborCollarletExpiryStrikeVolatilities.class, IborIndex.class);
    /**
     * The meta-property for the {@code valuationDateTime} property.
     */
    private final MetaProperty<ZonedDateTime> valuationDateTime = DirectMetaProperty.ofImmutable(
        this, "valuationDateTime", BlackIborCollarletExpiryStrikeVolatilities.class, ZonedDateTime.class);
    /**
     * The meta-property for the {@code surface} property.
     */
    private final MetaProperty<Surface> surface = DirectMetaProperty.ofImmutable(
        this, "surface", BlackIborCollarletExpiryStrikeVolatilities.class, Surface.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends BlackIborCollarletExpiryStrikeVolatilities> builder() {
      return new BlackIborCollarletExpiryStrikeVolatilities.Builder();
    }

    @Override
    public Class<? extends BlackIborCollarletExpiryStrikeVolatilities> beanType() {
      return BlackIborCollarletExpiryStrikeVolatilities.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 100346066:  // index
          return ((BlackIborCollarletExpiryStrikeVolatilities) bean).getIndex();
        case -949589828:  // valuationDateTime
          return ((BlackIborCollarletExpiryStrikeVolatilities) bean).getValuationDateTime();
        case -1853231955:  // surface
          return ((BlackIborCollarletExpiryStrikeVolatilities) bean).getSurface();
      }
   ...
   */
  private static final class Builder extends DirectPrivateBeanBuilder<BlackIborCollarletExpiryStrikeVolatilities> {
    ...
    @Override
    public BlackIborCollarletExpiryStrikeVolatilities build() {
      return new BlackIborCollarletExpiryStrikeVolatilities(
          index,
          valuationDateTime,
          surface);
