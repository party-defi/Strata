 ...
 */
public interface IborCollarletVolatilities
   ...
   * @return the name
   */
  public abstract IborCollarletVolatilitiesName getName();
  ...
  /**
   * Gets the type of volatility returned by the {@link IborCollarletVolatilities#volatility} method.
   * 
   * @return the type
   */
  ...
  @Override
  public abstract IborCollarletVolatilities withParameter(int parameterIndex, double newValue);

  @Override
  public abstract IborCollarletVolatilities withPerturbation(ParameterPerturbation perturbation);
